        ...
        <div className="flex items-center space-x-2 mb-4 md:mb-0">
          <WouterLink href="/">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center border-2 border-blue-300">
                <img src="/logo.png" alt="AllowanceApp Logo" className="h-10 w-10 object-cover" />
              </div>
