            ...
            <div className="relative bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-xl lg:w-[450px]">
              ...
              <div className="mb-6">
                <div className="flex justify-center mb-4">
                  <div className="w-36 h-36 rounded-full overflow-hidden flex items-center justify-center border-4 border-blue-300 bg-indigo-900/50">
                    <img src="/logo.png" alt="AllowanceApp Logo" className="h-32 w-32 object-cover" />
                  </div>
                </div>
